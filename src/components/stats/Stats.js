        ...
        <Row className="align-items-center">
          ...
          <Col className="col-lg-6">
            <div className="achievement-wrapper">
              <div className="single_achievement wow fadeInUp">
                <div className="icon">
                  <img
              ...
              <div className="single_achievement wow fadeInUp" data-wow-delay=".1s">
                <div className="icon">
                  <img
              ...
              <div className="single_achievement wow fadeInUp" data-wow-delay=".2s">
                <div className="icon">
                  <img
              ...
              <div className="single_achievement wow fadeInUp" data-wow-delay=".3s">
                <div className="icon">
                  <img
